...
require (
	...
	github.com/gardener/repo-tools v0.0.0-20260318125820-48ccc5f79c19
	github.com/gardener/repo-tools/hack/tools/logcheck v0.0.0-20260318125820-48ccc5f79c19
